...
\begin{itemize}
    \item A categorization of type errors based on constraint logic that helps to reason about complex type errors as compositions of 4 basic forms (Section \ref{sec:categories}).
...
% It is important to note that these categories are not mutually exclusive. In practice, a type error may exhibit characteristics from multiple categories.  A combination of strategies is required to best support programmers with error resolution.
