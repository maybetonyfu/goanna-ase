...
\begin{itemize}
    ...
    \item Goanna-IDE, an interactive Haskell development environment that support debugging type errors using Goanna's diagnositics. (Section \ref{sec:walkthrough})
    \item A categorization of type errors that help reasoning about complex type errors as compositions of 4 basic forms (Section \ref{sec:categories}).
